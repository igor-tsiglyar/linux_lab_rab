...
{                                                       /*команды O               */
    ...
    ARG = OBLZ[BAS_IND + CUR_IND + sm] * 0x1000000L+    /*формирование содержимого*/
          ...
          OBLZ[BAS_IND + CUR_IND + sm + 3];              /*                        */
                                                         /*и                       */
    VR[R1] = VR[R1] | ARG;                               /*побитовая дизъюнкция
                                                         /*с 1-м операндом              */

    return 0;                                            /*успешное заверш. прогр. */
}

int P_N()                                                /*  п р о г р а м м а     */
                                                         /*реализации семантики    */
{                                                        /*команды N               */
    int sm;                                              /*рабочая переменная      */
    ...
    ARG = OBLZ[BAS_IND + CUR_IND + sm] * 0x1000000L+     /*формирование содержимого*/
          ...
          OBLZ[BAS_IND + CUR_IND + sm + 3];              /*                        */
                                                         /*и                       */
    VR[R1] = VR[R1] & ARG;                               /*побитовая конъюнкция
                                                         /*с 1-м операндом              */
...
CONT1:
  ...
  for ( I = 0; I < ISPIS; I++ )                   /*перебирая все собираемые*/
   {      
                                      /*об'ектные файлы,        */
    if ((fp = fopen("examppl.tex", "rb" )) ==  NULL)
      goto ERR3;                                   /*                        */
    else                                          /* иначе:                 */
     {                                          /*                        */
